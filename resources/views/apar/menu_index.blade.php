...
<div class="content-wrapper">
        ...
        <div class="content-header-right col-md-6 col-12">
          <div class="dropdown float-md-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
              ...
              <button class="dropdown-item" name="create_record_3" id="create_record_3"><i class="la la-plus-circle"></i> Add Outlet</button>  
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="content-body">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs nav-linetriangle">
                      ...
                      <li class="nav-item">
                        ...
                        href="#tabIcon32" aria-expanded="false"><i class="la la-flag"></i> Menu Category</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="baseIcon-tab33" data-toggle="tab" aria-controls="tabIcon33"
                        href="#tabIcon33" aria-expanded="false"><i class="la la-flag"></i> Outlet</a>
                      </li>
                    </ul>
                    ...
                    <div class="tab-pane" id="tabIcon33" aria-labelledby="baseIcon-tab33">
                      <table id="tab_outlet" width="100%" class="table display nowrap table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Outlet Name</th>
        ...
        <div class="modal fade text-left" id="formModal_3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11"
        data-backdrop="static" data-keyboard="false" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header bg-info white">
              ...
              <form id="form_menu_3" method="post" enctype="multipart/form-data">
              @csrf
              <div class="modal-body">
                <div class="form-group">
                  <label for="companyName">Outlet Name</label>
                    <input type="text" class="form-control" placeholder="Outlet Name" id="outlet_name" name="outlet_name">
                </div>
              </div>
...
var vtable = $('#tab_outlet').DataTable({
 processing: true,
 serverSide: true,
 paging: false,
 searching: false,
...
vtable.on('draw.dt', function () {
  vtable.column(0, { search: 'applied', order: 'applied' }).nodes().each(function (cell, i) {
    ...
    $('#create_record_3').click(function(){
      $('.modal-title').text("Add Outlet");
      $('#c_action_button').val("Add");
      $('#action').val("Add");
      $('#formModal_3').modal('show');
    });
    ...
    $('#form_menu_3').on('submit', function(event){
      event.preventDefault();
      
      if($('#action').val() == 'Add')
      {
        $.ajax({
          url:"{{ route('outlet_store') }}",
          method:"POST",
          data: new FormData(this),
          contentType: false,
          cache:false,
