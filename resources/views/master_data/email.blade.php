...
<div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Log Email </h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Log Email
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="content-header-right col-md-6 col-12">
          <div class="dropdown float-md-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
              <button class="dropdown-item" name="create_record" id="test_email"><i class="la la-plus-circle"></i> Test Email</button>  
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="companyName">Message</label>
                    <textarea class="form-control" placeholder="Full Name" id="message" name="message" required></textarea>
                </div>
              </div>
