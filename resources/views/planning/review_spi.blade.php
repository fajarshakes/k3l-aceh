...
<div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Review Satuan Pengawas Interen (SPI) </h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Review SPI
                </li>
              </ol>
            </div>
          </div>
                ...
                <table id="table1" class="table display nowrap table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>500.000.000</td>
                          <td>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review SPI"><i class="la la-pencil-square"></i></button>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review LK"><i class="la la-pencil-square"></i></button>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review BMN"><i class="la la-pencil-square"></i></button>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review Absensi"><i class="la la-pencil-square"></i></button>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review Persediaan"><i class="la la-pencil-square"></i></button>
                          <button type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-original-title="Review Lakin"><i class="la la-pencil-square"></i></button>
                          </td>
                        </tr>
