                          ...
                          <table id="tbl-pelaksana" class="table display nowrap table-striped table-bordered add-rows">
                            ...
                            @foreach($pelaksana_kerja as $pelaksana)
                              <tr class="baris_pelaksana">
                                ...
                                <td class="text-center" style="vertical-align:middle;"><button type="button" id="hapus_pelaksana" class="hapus_pelaksana btn btn-danger btn-sm"><i class="la la-trash-o"></i></button></td>
                              </tr>
                            @endforeach
                            </tbody>
                          </table>
