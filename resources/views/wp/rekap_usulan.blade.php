...
<div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Rekap Usulan </h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Rekap Usulan
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Daftar Rekap Usulan </h4>
                ...
                <table id="table1" class="table display nowrap table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>340.000.000</td>
                          <td>
                            <button type="button" onclick="window.location='/planning/d_usulan/1000';" class="btn btn-icon btn-info btn-xs"><i class="la la-search-plus"></i>  View Detail </button>
                          </td>
                        </tr>
